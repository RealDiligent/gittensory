...
export const ContributorNotificationFeedSchema = z
  .object({
    login: z.string(),
  ...
  .openapi("ContributorNotificationFeed");

export const ContributorNotificationsMarkReadSchema = z
  .object({
    login: z.string(),
    marked: z.number(),
    summary: z.string(),
  })
  .openapi("ContributorNotificationsMarkRead");
